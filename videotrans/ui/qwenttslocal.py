...
class Ui_qwenttslocal(object):
    def setupUi(self, qwenttslocal):
        ...
        h1_model = QtWidgets.QHBoxLayout()
        self.model = QComboBox()
        self.model.addItems(["0.6B", "1.7B"])
        h1_model.addWidget(QLabel('模型（首次使用时下载）' if defaulelang=='zh' else 'Model (downloaded on first use)'))
        h1_model.addWidget(self.model)
        v1.addLayout(h1_model)
